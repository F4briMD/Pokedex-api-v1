    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundColor: `rgba(var(--color-${pokemon.types[0].type.name}),0.33)`,
          }}
        >
          <img
            src={blackAndWhiteSpriteUrl}
            alt={`Pokemon ${pokemon.name}`}
            className=""
          />
        </div>
        <span className="absolute left-0 right-0 ml-2 text-sm font-bold text-gray-700">
          #{pokemon.id}
        </span>
